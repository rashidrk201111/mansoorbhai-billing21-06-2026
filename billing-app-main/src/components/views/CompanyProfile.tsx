...
export function CompanyProfile() {
  ...
  const handleLogoUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      setMessage({ type: 'success', text: 'Logo uploaded successfully! Remember to save your profile.' });
    } catch (error) {
  ...
  const handleRemoveLogo = () => {
    ...
    setMessage({ type: 'success', text: 'Logo removed. Remember to save your profile.' });
  };
            ...
            <div className="flex items-start gap-6 mb-6">
                ...
                {profile.logo_url ? (
                  <div className="relative inline-block">
                    <img
                      ...
                      alt="Company Logo"
                      className="h-32 w-auto object-contain border-2 border-slate-200 rounded-lg p-2 bg-white"
                    />
                    <button
                      type="button"
                      onClick={handleRemoveLogo}
                      className="absolute -top-2 -right-2 p-1.5 bg-red-600 hover:bg-red-700 text-white rounded-full transition shadow-lg"
                      title="Remove logo"
                    >
                      <X className="w-4 h-4" />
                    </button>
                  ...
                  <div className="h-32 w-48 border-2 border-dashed border-slate-300 rounded-lg flex items-center justify-center bg-slate-50">
              ...
              <div className="flex-1">
                <label className="block">
                  ...
                  <label
                    htmlFor="logo-upload"
                    className="flex items-center gap-2 px-4 py-2.5 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg transition cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed inline-flex"
                  >
                    {uploading ? (
                      <>
